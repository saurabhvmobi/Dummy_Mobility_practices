...
@interface FreeSlotsViewController ()<CLWeeklyCalendarViewDelegate,PasswordManagerDelegate,RoomManagerDelegate>
{
    NSIndexPath *selectedIndexPath;
    NSMutableArray *freeSlotsArray;
...
- (CLWeeklyCalendarView *)calendarView
{
    if(!_calendarView)
    {
        _calendarView = [[CLWeeklyCalendarView alloc] initWithFrame:CGRectMake(0, 0, self.containerForCalendar.bounds.size.width, 79)];
